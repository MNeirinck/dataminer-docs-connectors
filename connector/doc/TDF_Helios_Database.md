...
| 1.0.5.x [SLC Main] | Changed CAT and F3 eDliveR sites structure to each have 1 site view and 1 elements view. | 1.0.4.6 | New structure needs to be applied to the existing sites for the connector to work. |
